...
//	public class DBSCANClusterer<Point extends Clusterable> {
//    	
//    	
...
//         */
//        public List<Cluster<Point>> cluster(final Collection<Point> points) throws NullArgumentException {
//
//            // sanity checks
//            MathUtils.checkNotNull(points);
//
//            final List<Cluster<Point>> clusters = new ArrayList<Cluster<Point>>();
...
//                    final Cluster<Point> cluster = new Cluster<Point>();
...
//                if (point != neighbor && distanceFrom(point, neighbor) <= eps) {
...
//        }
//        
//        public double distanceFrom(Point p, Point q)
//    	{
